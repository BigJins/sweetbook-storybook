...
네 역할(main/reviewer · backend-ai · frontend-ui · validation-reviewer)에 dispatch할 때 그대로 복사해 쓸 수 있는 운영 지침.
...
| [`validation-reviewer.md`](validation-reviewer.md) | feature 브랜치 검증 + merge readiness 판정 + 통합 체크리스트 | `main` (`C:/dev/sweetbook-storybook`) | 상위 (Opus 등급) |
